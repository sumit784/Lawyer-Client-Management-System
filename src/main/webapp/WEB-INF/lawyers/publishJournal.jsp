...
<ul>
        ...
        <li><a href="/findCase">Search Cases</a></li>
...
<h2 class="title">Publish Weekly Journal</h2>
<p>&nbsp;</p>
<form:form id='login-form' action="/publishJournal" method='POST' modelAttribute="massmail">
